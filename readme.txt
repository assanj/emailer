...
Windows:
  Download emailer-windows-*.zip
  Extract to desired location
  Edit emailer.ini with your SMTP settings
  Run emailer.exe from command line

Linux (DEB):
  sudo dpkg -i emailer_*_amd64.deb
  Edit /etc/emailer/emailer.ini
  Run: emailer --subject "Test"

Linux (RPM):
  sudo rpm -i emailer-*.rpm
  Configure emailer.ini
  Use: emailer --help

Linux (AppImage):
  chmod +x emailer-*.AppImage
  ./emailer-*.AppImage --subject "Test"

macOS:
  Download emailer-macos-*.zip
